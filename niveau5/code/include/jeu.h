...
/** 
 * \brief cherche si la colonie est oscillante
 * \relatesalso grille
 * \param g (pointeur vers) la grille de départ
 * \param periode_max nombre de pas de temps maximum pour la recherche 
 * \return la période (si une oscillation est trouvée), -1 sinon
 * \pre \b periode_max > 0
 */
